# File Location: .local/small-loop/jitx/small_loop/imports/SmallLoop/components/UNKNOWN/comma_ai_11112255_M2X4.py 
...
class Symbolcomma_ai_11112255_M2X4(Symbol):
    ...
    draws = [
        Text(">REF", 1.19, Anchor.S).at((0, 6.29921)),
        Text(">VALUE", 1.19, Anchor.S).at((0, 4.72441)),
        Text("pcbgolf:2X04", 1, Anchor.C).at((0, 3.14961)),
