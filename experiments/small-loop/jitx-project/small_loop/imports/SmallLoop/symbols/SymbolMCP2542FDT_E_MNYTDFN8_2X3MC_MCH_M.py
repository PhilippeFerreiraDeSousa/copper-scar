# File Location: .local/small-loop/jitx/small_loop/imports/SmallLoop/symbols/SymbolMCP2542FDT_E_MNYTDFN8_2X3MC_MCH_M.py 
from jitx.symbol import Symbol, Pin, Direction
from jitx.shapes.primitive import Polyline


class SymbolMCP2542FDT_E_MNYTDFN8_2X3MC_MCH_M(Symbol):
    pin_name_size = 1.2
    pad_name_size = 1.2
