# File Location: .local/small-loop/jitx/small_loop/imports/SmallLoop/symbols/Symbolcomma_ai_11112255_TVS_BI_0402_DFN.py 
from jitx.symbol import Symbol, Pin, Direction
from jitx.shapes.primitive import Polyline


class Symbolcomma_ai_11112255_TVS_BI_0402_DFN(Symbol):
    pin_name_size = 0
    pad_name_size = 0
    p = {
