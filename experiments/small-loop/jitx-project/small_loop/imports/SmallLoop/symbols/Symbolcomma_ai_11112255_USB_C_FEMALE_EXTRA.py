# File Location: .local/small-loop/jitx/small_loop/imports/SmallLoop/symbols/Symbolcomma_ai_11112255_USB_C_FEMALE_EXTRA.py 
from jitx.symbol import Symbol, Pin, Direction
from jitx.anchor import Anchor
from jitx.shapes.primitive import Polyline, Text


class Symbolcomma_ai_11112255_USB_C_FEMALE_EXTRA(Symbol):
    pin_name_size = 1.2
    pad_name_size = 1.2
    VBUS = {
