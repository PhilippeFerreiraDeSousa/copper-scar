# File Location: .local/small-loop/jitx/small_loop/imports/SmallLoop/symbols/Symbolcomma_ai_11112255_LED_LITEON.py 
from jitx.symbol import Symbol, Pin, Direction
from jitx.shapes.primitive import Polyline, Polygon


class Symbolcomma_ai_11112255_LED_LITEON(Symbol):
    pin_name_size = 0
    pad_name_size = 0
