# File Location: .local/small-loop/jitx/small_loop/imports/SmallLoop/symbols/Symbolcomma_ai_11112255_L_US_1210.py 
from jitx.symbol import Symbol, Pin, Direction
from jitx.shapes.primitive import Arc, ArcPolyline


class Symbolcomma_ai_11112255_L_US_1210(Symbol):
    pin_name_size = 0
    pad_name_size = 0
    p = {
