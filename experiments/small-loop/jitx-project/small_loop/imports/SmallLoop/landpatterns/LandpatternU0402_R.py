# File Location: .local/small-loop/jitx/small_loop/imports/SmallLoop/landpatterns/LandpatternU0402_R.py 
...
class LandpatternU0402_R(Landpattern):
    p = {
    ...
    # Model3D file not found: "${KIPRJMOD}/pcbgolf.3dshapes/Resistor_SMD.3dshapes/R_0402_1005Metric.step"
