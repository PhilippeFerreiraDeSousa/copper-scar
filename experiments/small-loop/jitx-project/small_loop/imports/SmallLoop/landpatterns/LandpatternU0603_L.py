# File Location: .local/small-loop/jitx/small_loop/imports/SmallLoop/landpatterns/LandpatternU0603_L.py 
...
class LandpatternU0603_L(Landpattern):
    ...
    # Model3D file not found: "${KIPRJMOD}/pcbgolf.3dshapes/Inductor_SMD.3dshapes/L_0603_1608Metric.step"
