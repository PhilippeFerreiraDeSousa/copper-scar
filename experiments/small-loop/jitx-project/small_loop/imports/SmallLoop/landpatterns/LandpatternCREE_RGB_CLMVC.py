# File Location: .local/small-loop/jitx/small_loop/imports/SmallLoop/landpatterns/LandpatternCREE_RGB_CLMVC.py 
...
class LandpatternCREE_RGB_CLMVC(Landpattern):
    ...
    # Model3D file not found: "${KIPRJMOD}/pcbgolf.3dshapes/LED_SMD.3dshapes/CLMVC-FKA-CL1D1L71BB7C3C3.step"
