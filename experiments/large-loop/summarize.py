...
order=['input-verified','routing-control-01','routing-control-02','placement-01','placement-02','placement-03','placement-04','retained-repeat']
for name in order:
 f=base/name
