...
from .imports.LargeLoop.LargeLoop import Main
from .imports.LargeLoop.board import BoardLargeLoop, SubstrateLargeLoop, DesignRules
...
class PreservedSubstrate(SubstrateLargeLoop):
    ...
    class ThroughVia(Via):
        ...
        tented = True
        via_in_pad = False
class LargeLoopInput(Design):
    circuit = Main()
    board = BoardLargeLoop()
