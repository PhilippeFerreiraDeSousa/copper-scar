...
from .imports.MediumLoop.MediumLoop import Main
from .imports.MediumLoop.board import BoardMediumLoop, SubstrateMediumLoop, DesignRules
...
class PreservedSubstrate(SubstrateMediumLoop):
    ...
    class ThroughVia(Via):
        ...
        tented = True
        via_in_pad = False
class MediumLoopInput(Design):
    circuit = Main()
    board = BoardMediumLoop()
