...
oldboxes=[(q.GetNetname(),q.GetBoundingBox()) for q in oldpads]
for ref in refs:
...
for t in list(b.GetTracks()):
 ...
 if owners<=refs:
  ...
  detach=cfg.get('copper_policy')!='detach_moved_pad_incident' or any(n==net and (box.Contains(t.GetStart()) or box.Contains(t.GetEnd())) for net,box in oldboxes)
