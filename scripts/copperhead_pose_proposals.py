...
for dx,dy in deltas+([(0,0)] if any(rotations) else []):
 for rotation in rotations:
  ...
  item={'translation_mm':[dx,dy],'rotation_deg':rotation,'geometry_screen':legal}
  if legal:
   if len(refs)==1:
