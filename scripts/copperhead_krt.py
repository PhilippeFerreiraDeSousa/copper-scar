...
(c/'krt-invocation.json').write_text(json.dumps(dict(argv=argv,environment={k:env[k] for k in ['KICAD_CLI','KICAD_PYTHON']},qualification='Diagnostic routing trial only; independent original-rule DRC required'),indent=2))
