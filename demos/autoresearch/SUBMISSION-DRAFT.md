...
R89 audit limitation: the preview also reassigned the existing via at (205.05,86.75) from Net-(LED13-AR) to CH4_SBU1_IGN. The existing guard checked preview-to-final, so it did not establish parent-to-preview via net preservation. The rejected result split R89.2 from Q5.1/U3.84/R81.1 on CH4_SBU1_IGN. The independent audit is packaged; no claim of preserving all original via net identities is made for R89.
