...
What makes the demo useful: It exposes a local placement edit that appears promising but splits an existing connected group, and refuses to retain it. The challenger reaches 44 missing pairs one decision earlier, while baseline catches up on its second decision. The final package reports the actual terminal comparison outcome; early advantage is not a final winner. Independent partition and trace-geometry evidence constrains the causal story.
