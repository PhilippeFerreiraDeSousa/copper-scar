# File Location: b-unassigned-nc-output/converted/imports/Pcbgolf/components/UNKNOWN/LQM2MPN2R2NG0L.py 
# To import this component:
#     from .components.UNKNOWN import LQM2MPN2R2NG0L
#     u1 = LQM2MPN2R2NG0L.LQM2MPN2R2NG0L()
...
class LandpatternU0806(Landpattern):
    ...
    models = [
        Model3D("L_Cenker_CKCS201610.step",
            position=(0, 0, 0),
            scale=(1, 1, 1),
            rotation=(0, 0, 0),
        ),
...
class Symbolcomma_ai_11112255_L_US_0806(Symbol):
    pin_name_size = 0
    pad_name_size = 0
    p = {
    ...
    draws = [
        Text(">REF", 1.19, Anchor.W).at((-1, 2)),
        Text(">VALUE", 1.19, Anchor.W).at((-1, -4)),
        Text("pcbgolf:0806", 1, Anchor.C).at(Transform((0, 0), 270)),
...
class LQM2MPN2R2NG0L(Component):
    description = ""
    mpn = "LQM2MPN2R2NG0L"
    datasheet = ""
    reference_designator_prefix = "L4"
    landpattern = LandpatternU0806()
    p = {
        1: Port(),
        2: Port(),
    }
    symbol = Symbolcomma_ai_11112255_L_US_0806()
    mappings = [
        SymbolMapping({
            p[1]: symbol.p[1], 
            p[2]: symbol.p[2]
...
Device: type[LQM2MPN2R2NG0L] = LQM2MPN2R2NG0L
