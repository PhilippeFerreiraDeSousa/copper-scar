...
class Pcbgolf_5_05(Circuit):
    ...
    def __init__(self):
        self.place(self.C53, Transform((46.19839, 47.91825), rotate=0), on=Side.Top)
        self.place(self.J8, Transform((27.55293, 35.05)))
        self.place(self.LED9, Transform((41.19839, 42.91825), rotate=0), on=Side.Top)
        self.place(self.R69, Transform((41.19839, 52.91825), rotate=0), on=Side.Top)
        self.place(self.R73, Transform((37.19839, 52.91825), rotate=0), on=Side.Top)
        self.place(self.R77, Transform((37.19839, 42.91825), rotate=0), on=Side.Top)
        self.place(self.U16, Transform((41.19839, 47.91825), rotate=0), on=Side.Top)
...
class Pcbgolf_2_2(Circuit):
    ...
    def __init__(self):
        ...
        self.place(self.R20, Transform((8.9904, 26.5085)))
...
class Main(Circuit):
    ...
    def __init__(self):
        self.place(self.CAN_FD, Transform((9.3783, -76.6155), rotate=0), on=Side.Top)
        self.place(self.Channels, Transform((32.86084, 68.51825), rotate=180), on=Side.Top)
        self.place(self.Power, Transform((-72.2135, -12.1459), rotate=270), on=Side.Top)
        self.place(self.STM32H7, Transform((48.78745, 8.118), rotate=0), on=Side.Top)
        self.place(self.USB__SD, Transform((-110.7699, 10.55), rotate=0), on=Side.Top)
